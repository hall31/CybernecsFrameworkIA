...
function App() {
  ...
  const [currentView, setCurrentView] = useState("startup"); // "startup" or "cogov"
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6 overflow-auto">
          ...
          {currentView === "cogov" && <CoGovernanceBoard />}
        </div>
      </div>
    </div>
  );
